...
// Template Name: More Information

get_header();

 ?>

<div id="primary" class="content-area content-area-site more-info-page">
	...
	<main id="main" class="site-main">
		...
		<div class="container">
			...
			<?php 
			$more_information_tabs = get_field('more_information_tabs');
			
			 ?>
			<!-- Nav tabs -->
	            <ul class="nav nav-pills nav-justified nav-more-information">
	            	<?php 
	            		$i = 1;
						foreach ($more_information_tabs as $list) {
							?>
	            ...
	            <div class="tab-content">
	            	<?php 
	            	$n = 1;
	            	foreach ($more_information_tabs as $data) {
	            		?>
